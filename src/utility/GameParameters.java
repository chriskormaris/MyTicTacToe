...
public class GameParameters {
    ...
    public GameParameters() {
        ...
        clientIP = "127.0.0.1";
        clientPort = 4001;
        XIcon = new ImageIcon(ResourceLoader.load(Utilities.getIconPath(Constants.X, "Blue")));
        OIcon = new ImageIcon(ResourceLoader.load(Utilities.getIconPath(Constants.O, "Red")));
    }
